...
/**
 * YOLO 런타임 기본 설정 (fused 전용, 임베디드 고려)
 *
 * - 기본값: fused 가중치/메타 사용 (weights_fused.bin, model_meta_fused.json)
 ...
 *     YOLO_WEIGHTS_DEFAULT_FILE="weights.bin"
 *     YOLO_META_DEFAULT_FILE="model_meta.json"
 *   )
 */
...
#define YOLO_WEIGHTS_DEFAULT_FILE "weights_fused.bin"
#endif
